...
<table width="100%" cellpadding="4" cellspacing="0" border="0" align="center">
  <tr> 
	<td align="center" ><a href="{U_FORUM_INDEX}" target="_parent"><img src="../templates/Raid/images/logo_phpBB_med.gif" border="0" /></a></td>
  </tr>
  <tr> 
	<td align="center" > 
	  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
        ...
        <tr> 
          <td class="row1"><span class="genmed"><a href="http://www.mikelothar.com/"  target="_blank" class="genmed">Raid updates</a></span></td>
        </tr>
	  </table>
	</td>
  </tr>
